...
class UserApi(object):
    ...
    def user_info_username_get(self, username, **kwargs):  # noqa: E501
        ...
        return self.user_info_username_get_with_http_info(username, **kwargs)  # noqa: E501

    def user_info_username_get_with_http_info(self, username, **kwargs):  # noqa: E501
        """Return a user's information.  # noqa: E501
        ...
        >>> thread = api.user_info_username_get_with_http_info(username, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method user_info_username_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'username' is set
        if self.api_client.client_side_validation and local_var_params.get('username') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `username` when calling `user_info_username_get`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('username' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `username` when calling `user_info_username_get`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
